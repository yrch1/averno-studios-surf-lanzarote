...
<html lang="<?php echo $locale ?>">
	<head>
		<title>Longboard - Surf-lanzarote.com</title>
		<?php include '../includes/head.php'; ?>
		<meta name="keywords" content="<?php echo translate('KEYWORDS_longboard',$locale) ?>"/>
		<meta name="description" content="<?php echo translate('DESCRIPTION_longboard',$locale) ?>"/>
	</head>
	...
	<body id="surf" >
		...
		<div class="container zone1">
			...
			<div class="row" id="row1">
				<div class="span12">
					<h1 class="color1">Longboard - Surf-lanzarote.com</h1>
							...
							<div class="bordeLateral" id="ajaxContainer1">
								<div class="row">
									<div class="span6 paddingRight20">
										<h3><?php echo translate('LONGBOARD_TEXTO_1',$locale) ?></h3>
		                               	<?php echo translate('LONGBOARD_TEXTO_2',$locale) ?>
		                                <div class="FotoDeApoyo"><img src="/images/Longboard-vs-shortboard.jpeg" height="320px" /> </div>
	                               </div>
	                             </div>
							</div>
						</div>
