...
<html lang="<?php echo $locale ?>">
	<head>
		<title>Surfing - Surf-lanzarote.com</title>
		<?php include '../includes/head.php'; ?>
		<meta name="keywords" content="<?php echo translate('KEYWORDS_surfing',$locale) ?>"/>
		<meta name="description" content="<?php echo translate('DESCRIPTION_surfing',$locale) ?>"/>
	<body id="surf" >
		...
		<div class="container zone1">
			...
			<div class="row" id="row1">
				<div class="span12">
					<h1 class="color1">Surfing - Surf-lanzarote.com</h1>
							...
							<div class="bordeLateral" id="ajaxContainer1">
								<div class="row">
									<div class="span6 paddingRight20">
										<h3><?php echo translate('SURF_TEXTO_1',$locale) ?></h3>
										<?php echo translate('SURF_TEXTO_2',$locale) ?>		                                
		                                <div class="FotoDeApoyo"><img src="/images/IMG_0719.jpg" width="210px">
											<?php echo translate('SURF_TEXTO_3',$locale) ?>
		                                </div>
	                               </div>
	                             </div>
							</div>
