...
<html lang="<?php echo $locale ?>">
	<head>
		<title>Sightseen - Surf-lanzarote.com</title>
		<?php include '../includes/head.php'; ?>
		<meta name="keywords" content="<?php echo translate('KEYWORDS_sightseen',$locale) ?>"/>
		<meta name="description" content="<?php echo translate('DESCRIPTION_sightseen',$locale) ?>"/>
	</head>
	...
	<body id="surf" >
		...
		<div class="container zone1">
			...
			<div class="row" id="row1">
				<div class="span12">
					<h1 class="color1">Sightseen - Surf-lanzarote.com</h1>
