...
<html lang="<?php echo $locale ?>">
		<head>
		<title>Trekking - Surf-lanzarote.com</title>
		<?php include '../includes/head.php'; ?>
		<meta name="keywords" content="<?php echo translate('KEYWORDS_trekking',$locale) ?>"/>
		<meta name="description" content="<?php echo translate('DESCRIPTION_trekking',$locale) ?>"/>
	</head>
	...
	<body id="surf" >
		...
		<div class="container zone1">
			...
			<div class="row" id="row1">
				<div class="span12">
					<h1 class="color1">Trekking - Surf-lanzarote.com</h1>
